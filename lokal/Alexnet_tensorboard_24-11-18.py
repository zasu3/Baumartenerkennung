...
tensorboard = TensorBoard(log_dir="/Users/zes3/Documents/Bachelor_Thesis/outputs/logdir/{}".format(time()), histogram_freq=1, batch_size = batch_size, write_graph = True, write_grads = True,
                          write_images = True, embeddings_freq = 1, embeddings_layer_names = [], update_freq = "epoch")
