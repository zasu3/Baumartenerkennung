...
fully_1 = model.add(Dense(96, activation='relu'))
...
# initialize
optimizer=keras.optimizers.Adam(lr=0.0005) #tf.keras.optimizers.Adam
model.compile(optimizer=optimizer, #tf.train.AdamOptimizer(0.0005),
...
model.save('07-12-18_3_Conv1_15epochs.h5')
