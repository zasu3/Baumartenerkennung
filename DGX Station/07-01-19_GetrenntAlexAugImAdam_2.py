...
log_dir = '07-01-19_GetrenntAlexAugImAdam_2'
...
model.compile(optimizer=optimizer, #tf.train.AdamOptimizer(0.0001),
...
modelpath = log_dir+'/07-01-19_GetrenntAlexAugImAdam_2.hdf5'
