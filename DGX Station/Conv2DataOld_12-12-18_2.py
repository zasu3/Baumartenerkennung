...
path1 = 'BaumbilderBA'    #path of folder of images DGX
#path2 = '/Users/zes3/Documents/Bachelor_Thesis/BaumbilderBA_augmented_farbig_227'  #path of folder to save images
path2 = 'BaumbilderBA_farbig_resized_227'  #path of folder to save images DGX
...
for folder in listing:
    ...
    for root, dirs, files in os.walk(path1 + "/" + folder):
        ...
        for file in files:
            ...
            img.save(path2 +'/' +  herkunftsort + '_' + file, "PNG")  
'''
