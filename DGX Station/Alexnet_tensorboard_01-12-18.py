...
log_dir = '/home/duser/outputs/logdir'
...
writer = tf.summary.FileWriter('/home/duser/outputs/logdir', sess.graph)

embedding_layer_names = set(layer.name
                            for layer in model.layers
                            if layer.name.startswith('conv'))

tensorboard = TensorBoard(log_dir="/home/duser/outputs/logdir", histogram_freq=1, batch_size = batch_size, write_graph = True, write_grads = True, write_images = True, embeddings_freq = 1, embeddings_layer_names = embedding_layer_names, embeddings_data=X_test, update_freq='epoch')
