...
tensorboard = TensorBoard(log_dir="/home/duser/outputs", histogram_freq=1, batch_size = batch_size, write_graph = True, write_grads = True, write_images = True, embeddings_freq = 1, embeddings_layer_names = embedding_layer_names, embeddings_data=X_test)#, update_freq='batch')
