...
#path1 = 'BaumbilderBA_augmented_training_resized_200'    #path of folder of images DGX
#path2 = '/Users/zes3/Documents/BaumbilderBA_augmented_farbig_227'  #path of folder to save images
path2 = 'BaumbilderBA_augmented_training_resized_200_rotated'  #path of folder to save images DGX
#path_val = 'BaumbilderBA_augmented_validation_resized_227'
path_valrot = 'BaumbilderBA_augmented_validation_resized_200_rotated'
...
imlistval = imlistvalrot # imlistval1 + 
...
print("Shape von immatrix2")#1, 2 und gesamt")
...
log_dir = '/home/duser/Visualisation_27-12-18_2/logdir'
...
checkpointer = ModelCheckpoint(filepath='/home/duser/Visualisation_27-12-18_2/tmp/weights.hdf5', verbose=1, save_best_only=True)
...
modelpath = "saved_models/27-12-18_2_visualisation.hdf5"
