...
conv_1 = model.add(Convolution2D(filters=96, kernel_size=(11, 11), strides=4, input_shape=input_shape))
...
conv_2 = model.add(Convolution2D(filters=256, kernel_size=(5, 5), strides=1))
...
print('image to visualize: ')
# save img_to_visualize
img_print = Image.fromarray(img_to_visualize, "RGB")
img_print.save('figures/Vis_14-12-18_2/img_to_visualize.png')
...
def layer_to_visualize(layer):
    ...
    for i in range(len(convolutions)):
        ...
        fig.savefig('figures/Vis_14-12-18_2/' + str(i) + '.png', bbox_inches='tight')
        plt.close(fig)
