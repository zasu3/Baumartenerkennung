...
def run(parambatchsize, paramlearnrate, paramfilters, parammaske):
    print("batchsize: " + str(parambatchsize))
    print("learnrate: " + str(paramlearnrate))
    print("filters: " + str(paramfilters))
    print("maske: " + str(parammaske))
    
    # prepare parameters and data
    batch_size = parambatchsize
    num_classes = 11
    epochs = 30
    ...
    conv_1 = model.add(Conv2D(filters=paramfilters, kernel_size=(parammaske, parammaske), strides=4, activation='relu', input_shape=input_shape))
    # max pooling 1
    ...
    # initialize
    model.compile(optimizer=tf.train.AdamOptimizer(paramlearnrate),
    ...
    #modelpath = log_dir+'/05-01-19_Augmented_2.hdf5'
...
#run(64, 0.0001, 96, 11)
#run(100, 0.0001, 96, 11)
#run(200, 0.0001, 96, 11)
#run(250, 0.0001, 96, 11)
'''run(64, 0.001, 96, 11)
run(100, 0.001, 96, 11)
run(200, 0.001, 96, 11)
run(250, 0.001, 96, 11)
